...
// ---------------------------------------------------------------------------
// estimateTokenSplit — mirror of app.js
// Estimates the prompt/completion split of a token slice by applying the
...
// ---------------------------------------------------------------------------
export function estimateTokenSplit(tokens, promptTokensTotal, completionTokensTotal) {
